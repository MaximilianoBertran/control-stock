...
class PinNotification extends Notification
{
    use Queueable;
    ...
    public function toArray($notifiable)
    {
        return [
            ...
            'nacionalidad' => $this->notificacion->nacionalidad,
            'user_id' => $this->notificacion->user_id,
            'tipo' => $this->notificacion->tipo,
            'comentario' => $this->notificacion->comentario,
            'nombre_origen' => $this->notificacion->nombre_origen
        ];
    }
}
